...
import {
  ...
  Wrench, ImagePlus, FileImage, Palette, X, ChevronDown, ScanLine
} from 'lucide-react'
...
const tools: Tool[] = [
  ...
  { title: 'Scan to PDF', desc: 'Use your camera to scan documents into a PDF.', icon: ScanLine, implemented: true, path: '/scan-to-pdf', category: 'Convert', color: 'text-fuchsia-500', bg: 'bg-fuchsia-50 dark:bg-fuchsia-900/20' },
]
